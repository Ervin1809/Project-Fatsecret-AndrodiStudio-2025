...
public final class IngredientContract {
    ...
    public static class IngredientEntry implements BaseColumns {
        ...
        public static final String COLUMN_FDC_ID = "fdc_id";
        public static final String COLUMN_API_SOURCE = "api_source";
    ...
    public static final String SQL_CREATE_TABLE =
            "CREATE TABLE " + IngredientEntry.TABLE_NAME + " (" +
                    ...
                    IngredientEntry.COLUMN_FDC_ID + " INTEGER," +
                    IngredientEntry.COLUMN_API_SOURCE + " TEXT," +
                    IngredientEntry.COLUMN_LAST_UPDATED + " TEXT)";
